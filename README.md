...
Сайт можете посмотреть по этой [ссылке](https://artreval.kz/)
...
Запуск файла в директориях prod и dev init-letsencrypt.sh будет собирать docker контейнеры и получать SSL сертификаты и поднимет сервер
